...
function Portfolio() {
  return (
    <div className="flex gap-4 h-full w-full overflow-y-auto flex-wrap items-center justify-center">
      <ProjectCard
        name="Music"
        description="First ever frontend project, a music player"
        image="/music_preview.png"
        language="angular"
      />
      <ProjectCard
        name="TextMage"
      ...
      <ProjectCard
        name="PdfMage"
        description="Merges images into a PDF file"
        image="/pdfmage_preview.png"
        language="react"
      />
      <ProjectCard
        name="VoiceNote"
        ...
        language="react"
      />
      <ProjectCard name="Snake" description="Snake game" image="/snake_preview.png" language="react" />
      <ProjectCard
        name="Minesweeper"
        description="Classic minesweeper"
        image="/minesweeper_preview.png"
        language="python"
      />
    </div>
  );
