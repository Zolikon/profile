    ...
    <div className={`flex fixed left-0 top-0 h-full ${isOpen && "w-full"} z-50 `}>
      <div className="relative flex items-center w-full">
        <motion.header
          ...
          className="bg-gradient-to-b from-light-side-from to-light-side-to dark:from-dark-side-from dark:to-dark-side-to text-light-text dark:text-dark-text p-4 h-[550px] sm:h-4/5 my-auto flex flex-col justify-between items-center rounded-r-2xl z-[52]"
        >
        ...
        {isOpen && <div className="absolute top-0 left-0 w-full h-full backdrop-blur-sm z-[51]" />}
      </div>
    </div>
  );
};
